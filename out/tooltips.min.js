var GW2TooltipsV2 = (function (exports) {
    ...
    function generateToolTip(apiObject, slotName, notCollapsable, iconMode, context, weaponSet) {
    ...
    function generateToolTipList(initialAPIObject, gw2Object, context, statSetId, stackSize) {
        ...
        if ('palettes' in initialAPIObject) {
            ...
            if (group) {
                ...
                while (candidate.previous_chain_skill_index) {
                    ...
                    tooltipChain.splice(insertAtIndex, 0, generateToolTip(skill, slot, false, 1, context, weaponSet));
                    candidate = otherCandidate;
                }
            }
            tooltipChain.push(generateToolTip(initialAPIObject, slot, false, 1, context, weaponSet));
            for (let j = 0; j < i; j++) {
                ...
                tooltipChain.push(generateToolTip(skill, slot, false, 1, context, weaponSet));
                i = j;
                j = -1;
            }
        }
            ...
            if ('type' in initialAPIObject) {
                ...
                tooltipChain.push(generateToolTip(initialAPIObject, slotName, false, 1, context, weaponSet));
            }
        }
        if ('bundle_skills' in initialAPIObject) {
            for (const subSkillId of initialAPIObject.bundle_skills) {
                ...
                if (subSkillInChain && canBeUsedOnCurrentTerrain(subSkillInChain, context)) {
                    ...
                    tooltipChain.push(generateToolTip(subSkillInChain, refineSlotName(palette, group === null || group === void 0 ? void 0 : group.slot), false, 1, context, weaponSet));
                }
            }
        }
        if ('related_skills' in initialAPIObject) {
            ...
            for (const subSkillId of initialAPIObject.related_skills) {
                ...
                if (subSkillInChain && canBeUsedOnCurrentTerrain(subSkillInChain, context) && ((type != 'skill') || subSkillInChain.palettes.some(pid => {
                    ...
                    const [palette, group] = guessGroupAndContext(subSkillInChain, context);
                    tooltipChain.push(generateToolTip(subSkillInChain, refineSlotName(palette, group === null || group === void 0 ? void 0 : group.slot), false, subiconRenderMode, context, weaponSet));
                }
            }
        }
        ...
        if ('skills' in initialAPIObject)
            for (const petSkillId of initialAPIObject.skills) {
                ...
                tooltipChain.push(generateToolTip(petSkill, refineSlotName(palette, group === null || group === void 0 ? void 0 : group.slot), true, subiconRenderMode, context, weaponSet));
            }
